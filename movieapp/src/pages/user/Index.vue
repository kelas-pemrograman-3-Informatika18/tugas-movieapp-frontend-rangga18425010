<template>
  <q-page padding>
    ...
    <q-carousel
      ...
      swipeable
    >
      <q-carousel-slide :name="1" img-src="https://ilmusisteminfo.com/upload/imagepost/26.jpg" />
      <q-carousel-slide :name="2" img-src="https://cdn2.tstatic.net/palu/foto/bank/images/fast-and-furious-9.jpg" />
    ...
    <q-card>
      ...
      <q-card-section class="q-pt-none">
        ...
        <div @click="movie.expanded = !movie.expanded" class="text-caption text-grey ellipsis-3-lines cursor-pointer">
          Tampilkan Deskripsi
        </div>
          <q-slide-transition>
